...
export default function MonitoramentoTV() {
  ...
  const [tvs, setTvs] = useState<TVStatus[]>([])

  async function carregar() {
    try {
      const response = await axios.get(`${API_URL}/api/tvs/status`)
        ...
        {tvs.map((tv) => (
          <div
            ...
            style={{
              ...
              border: `1px solid ${tv.online ? '#43a047' : '#e53935'}`,
            }}
          >
            <h3
              style={{
            ...
            <p>
              <strong>Playlist:</strong> {tv.playlist ?? 'Não vinculada'}
            </p>
            ...
            <div
              style={{
                ...
                background: tv.online ? '#1b5e20' : '#b71c1c',
